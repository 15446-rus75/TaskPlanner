...
public:
  ...
  // ИСПРАВЛЕНО: добавлены недостающие методы геймификации
  ...
  int getOnTimeCompletedCount() const override { return 0; }
  ...
  int getDeletedTasksCount() const override { return 0; }
  int getPerfectDaysCount() const override { return 0; }
  int getTotalLocationsCount() const override { return 0; }
  int getMaxTasksCompletedInOneDay() const override { return 0; }
  int getMaxHardTasksCompletedInOneDay() const override { return 0; }
